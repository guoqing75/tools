...
$h = "webr[1-5][a-b][1,3-4].us.abc.com";
define("DEBUG",1);
#in 1-9
#in a-g

#$s = "webr[1-2,3-5,7,9][a-b][1-4].us.abc.com";
...
{
    $h = "webr[1-5][a-b][1-5].us.abc.com";
    $h = "webr1[aa,bb,cc]1.us.abc.com";
    $h = "webr[1-5][a,b][1-5].us.abc.com";
    $h = "[web,mg]r[1-5][a,b][1-5].us.abc.com";
    $h = "webr[1-2,3-5,9,11][a-b]1.us.abc.com";
    parse2array($h);
    if(PARSE2ARRAY_DEBUG) {
        printf("DEBUG: h = %s\n", $h);
    }
